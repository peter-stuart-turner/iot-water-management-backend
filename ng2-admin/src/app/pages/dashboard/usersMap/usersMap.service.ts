    ...
    return {
      ...
      dataProvider: {
        ...
        areas: [
          ...
          */
          { title: 'South Africa', id: 'ZA', color: layoutColors.success, customData: '178', groupId: '1'},
          { title: 'Namibia', id: 'NA', color: layoutColors.danger, customData: '96', groupId: '4'},
          { title: 'Zambia', id: 'ZM', color: layoutColors.successLight, customData: '23', groupId: '3'},
          { title: 'Zimbabwe', id: 'ZW', color: layoutColors.primary, customData: '13', groupId: '2'},
        ]
      },
